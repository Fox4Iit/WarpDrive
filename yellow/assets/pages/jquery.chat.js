/**
* Theme: WarpDrive Admin Template
* Author: Coderthemes
* Chat application 
*/
...
!function($) {
    ...
    ChatApp.prototype.save = function() {
        ...
        if (chatText == "") {
            ...
            $('<li class="clearfix"><div class="chat-avatar"><img src="assets/images/avatar-1.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>Alex Templeton</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
            this.$chatInput.val('');
            this.$chatInput.focus();
